...
import br.ifpe.jaboatao.ts.builder.FilmesBuilder;
...
public class LocacaoServiceTest {
	...
	public void teste01() throws FilmesException {
		...
		List<Filme> filmes = Arrays.asList(FilmesBuilder.umFilme().agora());
	...
	public void excecao01() {
		// Cenário
		LocacaoService service = new LocacaoService();
		Usuario usuario = UsuarioBuilder.umUsuario().outroNome("Usuario 02").agora();
		List<Filme> filmes = Arrays.asList(FilmesBuilder.umFilme().semEstoque().agora());
		// Ação
		try {
			Locacao locacao = service.alugarFilme(filmes, usuario);
	...
	public void excecao05() {
		// Cenário
		LocacaoService service = new LocacaoService();
		Usuario usuario = UsuarioBuilder.usuarioVazio().agora();
		List<Filme> filmes = Arrays.asList(FilmesBuilder.umFilme().agora());
